...
#ifdef CONFIG_OV5645
static struct msm_camera_sensor_flash_data flash_ov5645 = {
    .flash_type = MSM_CAMERA_FLASH_NONE
};

static struct msm_camera_csi_lane_params ov5645_csi_lane_params = {
    .csi_lane_assign = 0xE4,
    .csi_lane_mask = 0x3,
};

static struct msm_camera_sensor_platform_info sensor_board_info_ov5645 =
{
    .mount_angle = 0,
    .gpio_conf = &apq8064_back_cam_gpio_conf,
    .i2c_conf = &apq8064_back_cam_i2c_conf,
    .csi_lane_params = &ov5645_csi_lane_params,
};

static struct msm_camera_sensor_info msm_camera_sensor_ov5645_data = {
    .sensor_name = "ov5645",
    .pdata = &msm_camera_csi_device_data[0],
    .flash_data = &flash_ov5645,
    .sensor_platform_info = &sensor_board_info_ov5645,
    .csi_if = 1,
    .camera_type = BACK_CAMERA_2D,
    .sensor_type = YUV_SENSOR,
};
...
#endif
#ifdef CONFIG_OV5645
		sensor_board_info_ov5645.mount_angle = 0;
#endif
...
static struct i2c_board_info apq8064_camera_i2c_boardinfo[] = {
	...
	.platform_data = &msm_camera_sensor_ov5640_data,
       ...
       .platform_data = &msm_camera_sensor_ov5645_data,
       },
#endif
	{
