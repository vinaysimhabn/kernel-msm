...
#define HIMAX_TS_I2C_ADDR		0x94
#define HIMAX_TS_S_RDY			6
#define HIMAX_TS_ATT_N			7
#define HIMAX_TS_RST_N			33
#define HIMAX_TS_3V3_EN			PM8921_GPIO_PM_TO_SYS(23)
#define HIMAX_8526A_HIGH_UA		12000
#define HIMAX_8526A_LOW_UA		30
#define HIMAX_8526A_MAX_UV		3300000
#define HIMAX_8526A_MIN_UV		2700000

static int apq8064_ts_himax_power(int on)
{
	if (on) {
		gpio_set_value(HIMAX_TS_3V3_EN, 1);
		msleep(20);
	}
	return 0;
}

static void apq8064_ts_himax_reset(void)
{
	gpio_direction_output(HIMAX_TS_RST_N, 0);
	msleep(30);
	gpio_direction_output(HIMAX_TS_RST_N, 1);

}

static struct himax_regulator himax_regulator_data[] = {
	{
		.name = "ts_avdd",
		.min_uV = HIMAX_8526A_MIN_UV,
		.max_uV = HIMAX_8526A_MAX_UV,
		.hpm_load_uA = HIMAX_8526A_HIGH_UA,
		.lpm_load_uA = HIMAX_8526A_LOW_UA,
	},
};
...
struct himax_i2c_platform_data apq8064_ts_himax_data = {
	.abs_x_min = 0,
	.abs_x_max = 480,
	.abs_y_min = 0,
	.abs_y_max = 800,
	...
	.inv_x = 1,
	.inv_y = 1,
	.gpio_irq = HIMAX_TS_ATT_N,
	.power = apq8064_ts_himax_power,
	.regulator_info = himax_regulator_data,
	.num_regulators = ARRAY_SIZE(himax_regulator_data),
	.reset = apq8064_ts_himax_reset,
	.cdata = &himax_config_data,
};

static struct i2c_board_info himax_info[] __initdata = {
	{
		I2C_BOARD_INFO(HIMAX8526A_NAME, HIMAX_TS_I2C_ADDR >> 1),
		.platform_data = &apq8064_ts_himax_data,
		.irq = MSM_GPIO_TO_INT(HIMAX_TS_ATT_N),
	},
};
...
#ifdef CONFIG_TOUCHSCREEN_HIMAX
	ret = gpio_request(HIMAX_TS_RST_N, "HIMAX_TS_RST_N");
	ret = gpio_export(HIMAX_TS_RST_N, true);
	ret = gpio_direction_output(HIMAX_TS_RST_N, 0);
	udelay(10);
#endif /* CONFIG_TOUCHSCREEN_HIMAX */
	}
